            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="glass-card p-6 md:p-8 rounded-2xl reveal relative overflow-hidden">
                    ...
                    <p className="mb-6 text-base md:text-lg leading-relaxed text-catchy-text font-medium">
                        Prior to IBM, I worked on Java-based applications and automated complex Database/ETL pipelines—slashing job runtimes by ~40%—at <strong className="text-catchy-heading">Deloitte</strong>. As an SDE Intern at <strong className="text-catchy-heading">Amazon</strong>, I worked across the full stack to optimize performance for critical enterprise systems. I rely on a strong foundation in <strong className="text-catchy-heading">System Design</strong> and <strong className="text-catchy-heading">Data Structures & Algorithms</strong> to consistently build highly scalable, fault-tolerant solutions.
                    </p>
